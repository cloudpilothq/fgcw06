        ...
        <div className="relative md:w-5/12 bg-gray-900 flex flex-col justify-between p-8 text-white min-h-[300px] md:min-h-full">
            ...
            <div className="relative z-10 flex justify-between items-start">
               ...
               <Link href="/" className="text-xs bg-white/10 hover:bg-white/20 backdrop-blur-md px-4 py-2 rounded-full transition-all flex items-center gap-2">
                 Back to website <ArrowLeft size={12} />
               </Link>
            </div>
        ...
        <div className="md:w-7/12 p-8 md:p-12 bg-[#1E1E1E] text-gray-200 flex flex-col justify-center">
            ...
            <div className="max-w-md mx-auto w-full">
                ...
                <p className="text-sm text-gray-400 mb-8">
                  Already have an account? <Link href="/login" className="text-[#006837] hover:text-green-400 font-medium underline-offset-4 hover:underline">Log in</Link>
                </p>
                ...
                <form action={dispatch} className="space-y-5">
                    ...
                    <div className="flex items-center">
                        <input id="terms" type="checkbox" className="w-4 h-4 text-[#006837] bg-[#2A2A2A] border-gray-600 rounded focus:ring-[#006837] focus:ring-offset-gray-800" />
                        <label htmlFor="terms" className="ml-2 text-sm text-gray-400">I agree to the <a href="#" className="underline hover:text-white">Terms & Conditions</a></label>
                    </div>

                    <button type="submit" className="w-full text-white bg-[#006837] hover:bg-[#00522b] focus:ring-4 focus:ring-green-900 font-medium rounded-lg text-sm px-5 py-4 text-center transition-all shadow-[0_4px_14px_0_rgba(0,104,55,0.39)]">
                        Create account
                    </button>

                     {state.message && (
                        <div className={`p-4 text-sm rounded-lg text-center ${state.message.includes('Error') || state.message.includes('Failed') ? 'bg-red-900/30 text-red-400' : 'bg-green-900/30 text-green-400'}`}>
                            {state.message}
                        </div>
                    )}
                </form>
                ...
                <div className="relative my-8">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-[#1E1E1E] px-2 text-gray-500">Or register with</span>
                    </div>
                </div>
